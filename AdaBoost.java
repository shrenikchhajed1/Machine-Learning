 ...
 * AdaBoost.java
 * ClassName : AdaBoost extends RandomForest
 * Purpose : Implements AdaBoost Technique which uses trees of RandomForest as classifiers.
 */
public class AdaBoost extends RandomForest {
	static int NO_TREES=30;	//Number of classifers 
	static double alpha[]=new double[32561];	//An array to store weights for each instance.
	...
	/*
	 * A method used to calcuate weighted erroe for each classifier.
	 * @param	An index of an classifier.
	 */
	...
	/*
	 * A method used to find wHAT for each classifier with minimum weighted error among other other classifiers.
	 * @return returns index of a classifier with minimum weighted error.
	 */
	...
	/*A method to update weights of each instance after every classifier classification.
	 * @param	It takes an index of classifier with minimum weighted error and updates the 
	 * 			weights of instaces according to that classifier wHat.
	 */
	...
	/*
	 * A method which classifies the testData based on final strong classifier which is
	 * linear combination of all weak classifiers.
	 * @return Returns predicitons of strong classifier on TestData.
	 */

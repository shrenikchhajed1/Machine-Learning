 ...
 * ID3.java
 * ClassName : NODE
 * Purpose :  Encapsulates information about nodes in the tree which includes its parent and children
 */
/* Class Node encapsulates information about each Node in tree and its parent and children*/
...
class Instance {
	static int ATTRIBUTES = 14; // Number of attributes = 14
	int label; 				// label=1 ==> +; label=0 ==> -; label=-1 ==> cannot decide
	Mapper map=new Mapper();  // Used to map attribute features 'Private' ==> 0 , 'SelfEmployee'==>1
	int fts[]=new int[ATTRIBUTES];		//this stores the features of each instance for 14 attributes
...
/* This class is used to find the split values for Continued value attributes using Gini Index.*/
class Split{
	...
	/*Use of gini method of Gini class to find split value.It populates array of split values i.e.split[]*/
				Gini gn = new Gini();
				split[k++]=gn.gini(a,b);
			}
		}
...
public class ID3 {
	...
	/**
	 * Generates the decision tree with the given impurity function.
	 * 
	 * @param tuples
	 *            The training data.
	 * @param f
	...
	/**
	 * Method used to classify testInstances
	 * @param	List of Test Instances
	 * @return	List of predctions for training instances
	 *
	 * */
	...
	/*
	 * Method used to compute accuracy of the classification.
	 */

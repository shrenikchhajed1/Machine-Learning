 ...
 * RandomForest.java
 * ClassName : RandomForest extends ID3
 * Purpose : Creates a random forest using various methods and overriding methods from ID3.
 */
import java.io.FileReader;
import java.util.*;
public class RandomForest extends ID3 {
	public static int [][]classification = new int[16281][2];	//classification table to store decisions of each tree.
 ...
 * @see ID3#expand(Node, ID3.ImpurityFunction, int)
 */
	...
	/*
	 * A method used to populate instances from given input file.
	 * @param
	 * 		Name of Input file.	
	 * @param
	 * 		List of instances to be populated.
	 */
	...
	/*
	 * A method used to find decision given a single tree for all the instnces.
